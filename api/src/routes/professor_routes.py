...
async def listar_professores(service: ProfessorService = Depends(get_professor_service)):
...
async def criar_professor(dados: ProfessorCreate, service: ProfessorService = Depends(get_professor_service)):
    try:
...
async def obter_professor(professor_id: int, service: ProfessorService = Depends(get_professor_service)):
    try:
...
async def atualizar_professor(professor_id: int, dados: ProfessorUpdate, service: ProfessorService = Depends(get_professor_service)):
    try:
...
async def deletar_professor(professor_id: int, service: ProfessorService = Depends(get_professor_service)):
    try:
